...
# Video instructions -------------------
  output$video <- renderUI({
   tags$video(type = "video/mp4", src = "video_with_captions.mp4", width="350px", height="350px", controls = "controls",  style="display: block; margin-left: auto; margin-right: auto;")
  })
...
# Define reactive values -------------------
  ...
  df_upload <- reactive({
    ...
    # Note to try later: once the analysis_data are loaded, make reactive sliders for ANCOVA
...
# Dataset 4: Calculate Correlations from SDs -------------------
  ...
  # Output table of correlation actionbutton   
